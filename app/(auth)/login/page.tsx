      ...
      <div className="relative w-full max-w-[440px] px-6">
        ...
        <Card className="border-slate-200/60 dark:border-slate-800 bg-white/70 dark:bg-slate-900/80 backdrop-blur-xl shadow-2xl shadow-slate-200/50 dark:shadow-none rounded-[2.5rem] overflow-hidden">
          <CardHeader className="pt-10 px-10 pb-4">
            ...
            <CardDescription className="text-slate-500 font-medium">Sign in to your account with email or social</CardDescription>
          </CardHeader>
          <CardContent className="p-10 pt-4 space-y-8">
            <form onSubmit={handleLogin} className="space-y-5">
              ...
              <Button
                type="submit"
                className="w-full h-14 rounded-2xl bg-slate-900 hover:bg-slate-800 text-white font-bold text-lg shadow-xl shadow-slate-200 dark:shadow-none transition-all active:scale-98"
            ...
            <div className="text-center pt-2">
              <span className="text-slate-500 font-medium">New to {SITE_CONFIG.name}? </span>
        ...
        <p className="mt-10 text-center text-slate-400 text-sm font-medium">
          Secure, encrypted authorization with Supabase.
        </p>
      </div>
    </div>
  )
