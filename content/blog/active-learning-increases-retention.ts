export const post = {
  ...
  keywords: ["active learning", "study retention", "learning retention techniques", "how to remember better", "active vs passive learning"],
  content: `
...
1. **Deeper encoding** - Your brain creates multiple neural pathways
2. **Retrieval practice** - Strengthens memory connections
3. **Metacognition** - You become aware of what you don't know
...
**Ask:** "Why does the cell need a powerhouse? How does it generate energy? What happens if mitochondria fail?"
...
**Traditional way (passive):**
Read textbook chapter → Highlight → Make notes → Hope you remember

**Active learning with Explore:**
1. Start with "Photosynthesis" topic
2. Get an AI-generated learning trail with branching questions
3. Answer: "What inputs does photosynthesis need?"
4. Get immediate feedback with explanations
5. Explore deeper: "Why does chlorophyll appear green?"
6. Connect concepts: "How does photosynthesis relate to cellular respiration?"
7. Flag difficult areas for spaced repetition
...
1. Write down everything you already know about the topic (retrieval)
2. List 5 questions you want answered
3. Predict how concepts might connect
...
2. Close your notes and explain it out loud
3. Generate 10 questions about it (or use an AI tool)
...
**Q: How long should I spend on active learning vs passive reading?**
A: Aim for 80% active (questions, practice, teaching) and 20% passive (initial reading). Most students do the opposite.

**Q: Can active learning work for memorization-heavy subjects?**
A: Yes! Self-testing and spaced repetition are active techniques perfect for vocabulary, formulas, and facts.

**Q: Is active learning faster than traditional studying?**
A: Per session, it feels slower. But because retention is higher, you spend less time re-learning forgotten material. Overall: 50% less total study time.

**Q: What if I don't know enough to ask questions?**
A: Start with basic questions: "What is X?", "Why does X matter?", "How does X work?" Tools like Explore can generate starter questions.
`
}
